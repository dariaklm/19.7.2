...
def test_add_new_pet_with_valid_data(name='Кузя', animal_type='сиамский',
...
def test_create_pet_without_photo_with_valid_data(name='Толик', animal_type='бигль',
                                                  age='1'):
    """Проверяем что можно добавить питомца с корректными данными"""
...
def test_add_new_pet_without_name(name='', animal_type='Бигль',
                                     age='13', pet_photo='images/dog1.jpg'):
...
def test_add_new_pet_without_photo(name='Жуля', animal_type='колли',
                                     age='5', pet_photo=''):
...
def test_add_new_pet_without_animal_type(name='Жуля', animal_type='',
...
def test_add_new_pet_without_age(name='Жуля', animal_type='колли',
...
def test_add_new_pet_without_uncorrect_age_type(name='Жуля', animal_type='колли',
                                     age='qwerty', pet_photo='images/dog1.jpg'):
...
def test_add_new_pet_with_age_more_then_2_symbols(name='Жуля', animal_type='колли',
                                     age='12345', pet_photo='images/dog1.jpg'):
...
def test_create_pet_without_photo_with_invalid_key (name='Толик', animal_type='бигль',
                                                  age='2'):
